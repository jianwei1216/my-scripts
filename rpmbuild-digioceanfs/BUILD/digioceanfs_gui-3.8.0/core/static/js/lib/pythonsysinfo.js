 ...
 ***************************************************************************/
//
// $Id: phpsysinfo.js 419 2011-01-18 08:28:56Z jacky672 $
//
...
function filesystemtable() {
    var html = "";
    html += "        <h2>" + genlang(30, false, 'Mounted Filesystems') + "</h2>\n";
    html += "        <table id=\"filesystemTable\" cellspacing=\"0\">\n";
    html += "          <thead>\n";
    html += "            <tr>\n";
    html += "              <th>" + genlang(31, false, 'Mountpoint') + "</th>\n";
    html += "              <th>" + genlang(34, false, 'Type') + "</th>\n";
    html += "              <th>" + genlang(32, false, 'Partition') + "</th>\n";
    html += "              <th>" + genlang(33, false, 'Usage') + "</th>\n";
    html += "              <th class=\"right\">" + genlang(35, true, 'Free') + "</th>\n";
    html += "              <th class=\"right\">" + genlang(36, true, 'Used') + "</th>\n";
    html += "              <th class=\"right\">" + genlang(37, true, 'Size') + "</th>\n";
    html += "            </tr>\n";
    html += "          </thead>\n";
    html += "          <tfoot>\n";
    ...
    html += "              <td>&nbsp;</td>\n";
    html += "              <td>&nbsp;</td>\n";
    html += "              <td>" + genlang(38, false, 'Totals') + "</td>\n";
...
function formatUptime(sec) {
    ...
    if (intDays) {
        txt += intDays.toString() + "&nbsp;" + genlang(48, false, 'days') + "&nbsp;";
    }
    if (intHours) {
        txt += intHours.toString() + "&nbsp;" + genlang(49, false, 'hours') + "&nbsp;";
    }
    return txt + intMin.toString() + "&nbsp;" + genlang(50, false, 'minutes');
}
...
function refreshVitals(xml) {
    ...
    $("Vitals", xml).each(function getVitals(id) {
        ...
        $("#s_distro").html("<img src='/static/theme/redmond/images/gfx/images/" + icon + "' alt='Icon' height='16' width='16' style='vertical-align:middle;' />&nbsp;" + distro);
...
function fillCpu(xml, tree, rootposition, collapsed) {
    ...
    $("Hardware CPU CpuCore", xml).each(function getCpuCore(cpuCoreId) {
        ...
        if (!isNaN(speed)) {
            html += "<tr><td style=\"width:50%\">" + genlang(13, true, 'CPU Speed') + ":</td><td>" + formatHertz(speed) + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        collapsed.push(cpucoreposition);
        if (!isNaN(cache)) {
            html += "<tr><td style=\"width:50%\">" + genlang(15, true, 'Cache Size') + ":</td><td>" + formatBytes(cache) + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        if (virt != undefined) {
            html += "<tr><td style=\"width:50%\">" + genlang(94, true, 'Virtualization') + ":</td><td>" + virt + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        if (!isNaN(bus)) {
            html += "<tr><td style=\"width:50%\">" + genlang(14, true, 'Bus Speed') + ":</td><td>" + formatHertz(bus) + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        if (!isNaN(bogo)) {
            html += "<tr><td style=\"width:50%\">" + genlang(16, true, 'System Bogomips') + ":</td><td>" + bogo.toString() + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        if (!isNaN(temp)) {
            html += "<tr><td style=\"width:50%\">" + genlang(51, true, 'Cpu Temp') + ":</td><td>" + formatTemp(temp, xml) + "</td></tr>\n";
            tree.push(cpucoreposition);
        }
        if (!isNaN(load)) {
...
function refreshHardware(xml) {
    ...
    $("#hardware").empty();
    html += "  <h2>" + genlang(10, false, 'Hardware Information') + "</h2>\n";
    html += "  <table id=\"HardwareTree\" class=\"tablemain\" style=\"width:100%;\">\n";
    html += "   <tbody class=\"tree\">\n";
    
    html += "    <tr><td colspan=\"2\"><b>" + genlang(11, false, 'Processors') + "</b></td></tr>\n";
    html += fillCpu(xml, tree, tree.push(0), closed);
    
    html += "    <tr><td colspan=\"2\"><b>" + genlang(17, false, 'PCI') + "</b></td></tr>\n";
    index = tree.push(0);
    //closed.push(index);
    html += fillHWDevice(xml, 'PCI', tree, index);
    
    html += "    <tr><td colspan=\"2\"><b>" + genlang(18, false, 'IDE') + "</b></td></tr>\n";
    index = tree.push(0);
    closed.push(index);
    html += fillHWDevice(xml, 'IDE', tree, index);
    
    html += "    <tr><td colspan=\"2\"><b>" + genlang(19, false, 'SCSI') + "</b></td></tr>\n";
    index = tree.push(0);
    closed.push(index);
    html += fillHWDevice(xml, 'SCSI', tree, index);
    
    html += "    <tr><td colspan=\"2\"><b>" + genlang(20, false, 'USB') + "</b></td></tr>\n";
    index = tree.push(0);
    closed.push(index);
...
function refreshNetwork(xml) {
    ...
    $("Network NetDevice", xml).each(function getDevice(id) {
        ...
        er = parseInt($(this).attr("Errors"), 10);
...
function refreshMemory(xml) {
    ...
    $("#memory").empty();
    html += "  <h2>" + genlang(27, false, 'Memory Usage') + "</h2>\n";
    html += "  <table id=\"MemoryTree\" class=\"tablemain\" style=\"width:100%;\">\n";
    html += "   <thead>\n";
    html += "    <tr>\n";
    html += "     <th style=\"width:200px;\">" + genlang(34, true, 'Type') + "</th>\n";
    html += "     <th style=\"width:285px;\">" + genlang(33, true, 'Usage') + "</th>\n";
    html += "     <th class=\"right\" style=\"width:100px;\">" + genlang(35, true, 'Free') + "</th>\n";
    html += "     <th class=\"right\" style=\"width:100px;\">" + genlang(36, true, 'Used') + "</th>\n";
    html += "     <th class=\"right\" style=\"width:100px;\">" + genlang(37, true, 'Size') + "</th>\n";
    html += "    </tr>\n";
    html += "   </thead>\n";
    html += "   <tbody class=\"tree\">\n";
    ...
    $("Memory", xml).each(function getMemory(id) {
        ...
        html += "<tr><td style=\"width:200px;\">" + genlang(28, false, 'Physical Memory') + "</td><td style=\"width:285px;\">" + createBar(percent) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(free, xml) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(used, xml) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(total, xml) + "</td></tr>";
        ...
        $("Memory Details", xml).each(function getMemorydetails(id) {
            ...
            if (!isNaN(app)) {
                html += "<tr><td style=\"width:184px;\">" + genlang(64, false, 'Kernel + Applications') + "</td><td style=\"width:285px;\">" + createBar(appp) + "</td><td class=\"right\" style=\"width:100px;\">&nbsp;</td><td class=\"right\" style=\"width:100px\">" + formatBytes(app, xml) + "</td><td class=\"right\" style=\"width:100px;\">&nbsp;</td></tr>";
                tree.push(memoryindex);
            }
            if (!isNaN(buff)) {
                html += "<tr><td style=\"width:184px;\">" + genlang(65, false, 'Buffers') + "</td><td style=\"width:285px\">" + createBar(buffp) + "</td><td class=\"rigth\" style=\"width:100px;\">&nbsp;</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(buff, xml) + "</td><td class=\"right\" style=\"width:100px;\">&nbsp;</td></tr>";
                tree.push(memoryindex);
            }
            if (!isNaN(cached)) {
                html += "<tr><td style=\"width:184px;\">" + genlang(66, false, 'Cached') + "</td><td style=\"width:285px;\">" + createBar(cachedp) + "</td><td class=\"right\" style=\"width:100px;\">&nbsp;</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(cached, xml) + "</td><td class=\"right\" style=\"width:100px;\">&nbsp;</td></tr>";
                tree.push(memoryindex);
            }
    ...
    $("Memory Swap", xml).each(function getSwap(id) {
        ...
        total = parseInt($(this).attr("Total"), 10);
        percent = parseInt($(this).attr("Percent"), 10);
        html += "<tr><td style=\"width:200px;\">" + genlang(29, false, 'Disk Swap') + "</td><td style=\"width:285px;\">" + createBar(percent) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(free, xml) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(used, xml) + "</td><td class=\"right\" style=\"width:100px;\">" + formatBytes(total, xml) + "</td></tr>";
