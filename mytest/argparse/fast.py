...
if __name__ == '__main__':
        parser = argparse.ArgumentParser (description='fast run cmd on specified multi hosts') 
        parser.add_argument ('--host', metavar='IP', type=str, nargs='+',
                             help='the host to run cmd')
        #parser.add_argument ('hello', dest='xxx', action='store_const',
                             #default=hello_world,
                             #help='print hello world on screen')
